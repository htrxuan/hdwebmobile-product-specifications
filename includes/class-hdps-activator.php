...
class HDPS_Activator
{

    public static function activate()
    {
        if (!self::is_woocommerce_active()) {
            deactivate_plugins(plugin_basename(HDPS_PLUGIN_FILE));
            set_transient('hdps_wc_missing_notice', true, 30);
            return;
        }
        ...
        // 'hdps_db_version' option -- see hdwebmobile-wholesale-pricing or
